              ...
              <div className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 p-6 space-y-4">
                <div className="relative">
                  <div className="flex justify-center">
                    <div
                      className={`inline-flex items-baseline px-4 py-1.5 text-base font-bold rounded-full ${getScoreClass(
                        event.score
                      )}`}
                    >
                      <span className="mr-2 text-sm font-semibold opacity-80">
                        SCORE
                      </span>
                ...
                <div className="space-y-4 border-t border-gray-100 pt-4">
                  <div>
                    ...
                    <p className="text-gray-800 leading-relaxed bg-pink-100 rounded-2xl p-5">
                      {event.text}
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-gray-800 leading-relaxed bg-indigo-100 rounded-2xl p-5">
                      {event.comment}
                    </p>
                  </div>
                </div>
